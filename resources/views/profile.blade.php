                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card-profile-stats">
                                <span class="heading">{{ Auth::user()->department->name }}</span>
                                <span class="description">Department</span>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card-profile-stats">
                                <span class="heading">{{ Auth::user()->jabatan }}</span>
                                <span class="description">Jabatan</span>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card-profile-stats">
                                <span class="heading">{{ $telat }} Kali</span>
                                <span class="description">Total Telat</span>
                            </div>
                        </div>
                    </div>
                </div>
