...
@section('main-content')
    ...
    <div class="row">
        ...
        @role('karyawan')
            <!-- Users -->
            <a class="col-xl-3 col-md-6 mb-4 text-decoration-none" href="{{ route('absen.index') }}">
                <div class="card border-left-success shadow h-100 py-2 bg-success">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-light text-uppercase mb-1">{{ __('Absen') }}</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">Klik Disini</div>
                            </div>
                            <div class="col-auto">
